...
DELETE FROM users WHERE email IN (
  'admin@standard-demo.com', 'teacher@standard-demo.com',
  'admin@plus-demo.com', 'teacher1@plus-demo.com', 'teacher2@plus-demo.com', 'teacher3@plus-demo.com',
  'admin@enterprise-demo.com', 'teacher1@enterprise-demo.com', 'teacher2@enterprise-demo.com', 'teacher3@enterprise-demo.com', 'teacher4@enterprise-demo.com'
);
...
SELECT @std_semester := LAST_INSERT_ID();
...
-- Students (8)
INSERT INTO students (madrasah_id, first_name, last_name, student_id, gender, class_id, date_of_birth, next_of_kin_name, next_of_kin_relationship, next_of_kin_phone) VALUES
...
-- Attendance (Saturdays for 4 weeks)
...
SET @plus_t1 := (SELECT id FROM users WHERE email = 'teacher1@plus-demo.com');
SET @plus_t2 := (SELECT id FROM users WHERE email = 'teacher2@plus-demo.com');
SET @plus_t3 := (SELECT id FROM users WHERE email = 'teacher3@plus-demo.com');

-- Session & Semester
INSERT INTO sessions (madrasah_id, name, start_date, end_date, is_active) VALUES
(@plus_id, '2025-2026', '2025-09-01', '2026-06-30', TRUE);
SELECT @plus_session := LAST_INSERT_ID();

INSERT INTO semesters (session_id, name, start_date, end_date, is_active) VALUES
(@plus_session, 'Semester 1', '2025-09-01', '2026-01-31', TRUE);
SELECT @plus_semester := LAST_INSERT_ID();
...
-- Attendance (Mon-Fri for Hifz, MWF for Arabic, TT for Islamic Sciences - 2 weeks)
...
-- Exams (2 subjects per class)
INSERT INTO exam_performance (madrasah_id, student_id, semester_id, teacher_id, subject, score, max_score, exam_date, notes) VALUES
-- Hifz Boys - Quran Memorization
...
SET @ent_t1 := (SELECT id FROM users WHERE email = 'teacher1@enterprise-demo.com');
SET @ent_t2 := (SELECT id FROM users WHERE email = 'teacher2@enterprise-demo.com');
SET @ent_t3 := (SELECT id FROM users WHERE email = 'teacher3@enterprise-demo.com');
SET @ent_t4 := (SELECT id FROM users WHERE email = 'teacher4@enterprise-demo.com');

-- Session & Semester
INSERT INTO sessions (madrasah_id, name, start_date, end_date, is_active) VALUES
(@ent_id, '2025-2026', '2025-09-01', '2026-06-30', TRUE);
SELECT @ent_session := LAST_INSERT_ID();

INSERT INTO semesters (session_id, name, start_date, end_date, is_active) VALUES
(@ent_session, 'Semester 1', '2025-09-01', '2026-01-31', TRUE);
SELECT @ent_semester := LAST_INSERT_ID();
...
SET @ent_s5 := (SELECT id FROM students WHERE madrasah_id = @ent_id AND student_id = '400005');
SET @ent_s6 := (SELECT id FROM students WHERE madrasah_id = @ent_id AND student_id = '400006');
SET @ent_s7 := (SELECT id FROM students WHERE madrasah_id = @ent_id AND student_id = '400007');
SET @ent_s8 := (SELECT id FROM students WHERE madrasah_id = @ent_id AND student_id = '400008');
...
-- Attendance (2 weeks sample for Alim and Hifz Boys)
-- Week 1 - Monday 2026-01-05
INSERT INTO attendance (madrasah_id, student_id, class_id, semester_id, teacher_id, date, present, dressing_grade, behavior_grade, notes) VALUES
