-- Seed Demo Madrasah with Complete Sample Data using Stored Procedure
-- This ensures all variables persist within the same scope
...
BEGIN
  ...
  DECLARE demo_session_id INT;
  DECLARE demo_semester_id INT;
  DECLARE demo_teacher1_id INT;
  DECLARE demo_teacher2_id INT;
  DECLARE class1_id INT;
  DECLARE class2_id INT;
  DECLARE class3_id INT;
  DECLARE class4_id INT;
  DECLARE student1_id INT;
  DECLARE student2_id INT;
  DECLARE student3_id INT;
  DECLARE student4_id INT;
  DECLARE student5_id INT;
  DECLARE student6_id INT;
  DECLARE student7_id INT;
  DECLARE student8_id INT;
  ...
  SET demo_semester_id = LAST_INSERT_ID();
  ...
  -- Insert Attendance Records for Boys Quran Class (attendance table uses user_id not teacher_id)
  ...
  -- Insert Attendance Records for Girls Hifz Class
