...
function ParentReport() {
  ...
  const [rankings, setRankings] = useState({ attendance: {}, exam: {}, dressing: {}, behavior: {} });
  ...
  const fetchReport = async () => {
    try {
      ...
      setDressingBehavior(data.dressingBehavior || { avgDressing: null, avgBehavior: null });
      setExams(data.exams);
      setRankings(data.rankings || { attendance: {}, exam: {}, dressing: {}, behavior: {} });
