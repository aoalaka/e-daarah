    ...
    <div className="landing">
      ...
      <header className={`landing-header ${scrolled ? 'header-scrolled' : ''}`}>
        ...
        <nav className="header-nav desktop-nav">
          ...
          <Link to="/docs" className="nav-link">User Guides</Link>
      ...
      {menuOpen && (
        <div className="mobile-menu-overlay" onClick={() => setMenuOpen(false)}>
          <nav className="mobile-menu" onClick={(e) => e.stopPropagation()}>
            ...
            <Link to="/docs" className="mobile-menu-link" onClick={() => setMenuOpen(false)}>User Guides</Link>
      ...
      <section className="hero">
        <div className="hero-inner">
          <div className="hero-content">
            <h1 className="hero-title">Everything <br />for madrasahs<span className="hero-title-dot">.</span></h1>
            ...
            <p className="hero-quran-link">
              <a href="#quran-free" onClick={(e) => { e.preventDefault(); document.getElementById('quran-free')?.scrollIntoView({ behavior: 'smooth' }); }}>
                Qur'an teacher? Get your free plan →
              </a>
            </p>
            ...
            <div className="attendance-card">
              ...
              <div className="ac-footer">
                <div className="ac-stat">
                  ...
                  <span className="ac-stat-value"><span className="ac-stat-desktop">4 / 5</span><span className="ac-stat-mobile">3 / 4</span></span>
                </div>
